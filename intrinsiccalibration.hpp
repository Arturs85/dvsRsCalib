#ifndef INTRINSICCALIBRATION_HPP
#define INTRINSICCALIBRATION_HPP
...
bool checkCorners(Mat cvImage);
  bool addImage(Mat cvImage);//uint8_t (*array)[arrayWidth][arrayHeight]);
...
#endif // INTRINSICCALIBRATION_HPP
