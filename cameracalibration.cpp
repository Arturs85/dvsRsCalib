...
bool CameraCalibration::checkCorners(cv::Mat cvImage)
{
    bool found =false;
...
bool CameraCalibration::addImageAsArray()//uint8_t (*array)[CameraCalibration::arrayWidth][CameraCalibration::arrayHeight])
{
if(isEnoughFrames)
...
void CameraCalibration::setStarted()
{
//    isCalibrationStarted=true;

}
bool CameraCalibration::setToSave = false;
void CameraCalibration::callBackFunc(int event, int x, int y, int flags, void* userdata)
{
...
void CameraCalibration::saveImage(cv::Mat mat)
{
